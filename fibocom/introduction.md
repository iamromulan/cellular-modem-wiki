...
Insert the FM190W modem into m.2-to-usb adapter. If your Windows system autoconnects the the FM190W, go to "Control Panel\Network and Internet\Network Connections and Network" and disable network interface for the modem.
