...
If you plan to use the RM551E-GL in an ethernet sled you need to edit some modem configurations. Use your favorite serial appplication (i.e TeraTerm)
  ...
  +QMAP: "WWAN",1,1,"IPV4","100.74.45.189"
...
Some diagnostic queries
  ...
  +QNWPREFCFG: "mode_pref",AUTO # default cambiato in 
  ...
  AT+CEREG?
  +CREG: 0,0
  AT+CEREG=2 # invia richiesta registrazione cella 4G/LTE

  AT+C5GREG?
  +C5GREG: 0,0
  AT+C5GREG=2 # invia richiesta registrazione cella 5G
