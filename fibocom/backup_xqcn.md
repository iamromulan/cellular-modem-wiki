...
> :book: During the flashing process some unique data will be erased, make sure you have valid backups as reported at [NV Restore Radio Calibration](./flash_firmware_windows.md#nv-restore-radio-calibration)
